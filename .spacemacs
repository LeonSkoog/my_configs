  ...
  (setq-default
   ...
   '(
     ...
     (c-c++ :variables
            ...
            c-c++-lsp-executable "/home/mateusz/bin/ccls"
            c-c++-lsp-sem-highlight-method 'font-lock
            c-c++-lsp-cache-dir "/tmp/lsp-cache"
            )
     ;; multiple-cursors
     org
     dap
  ...
  (c-add-style "work"
               '((indent-tabs-mode . nil)
                 ...
                 (c-offsets-alist
                  ...
                  (inextern-lang . 0)
                  (innamespace . 0))))
  (push '(other . "work") c-default-style)

  (setq ccls-initialization-options '(:cache
...
(custom-set-variables
 ...
 '(safe-local-variable-values
   (quote
    ((cmake-ide-build-dir . "~/Projects/Nauka/Algorytmy/zaprzyjaznij_sie_z_algorytmami/build")
     (cmake-ide-project-dir . "~/Projects/Nauka/Algorytmy/zaprzyjaznij_sie_z_algorytmami/source")
